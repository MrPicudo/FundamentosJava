...
public class Enteros {
    public static void main(String[] args) {
        ...
        System.out.println("Char \t\t   " + Character.MIN_VALUE + "\t\t\t  " + Character.MAX_VALUE + "\t\t\t  " + Character.BYTES);
        ...
        System.out.println("Número de tipo long = " + big);
